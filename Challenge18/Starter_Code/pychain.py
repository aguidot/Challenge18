...
# Instead of deleting I will leave it as this: input_data = st.text_input("Block Data")
...
# Again, amount is called shares for this code file
...
if st.button("Add Block"):
    ...
    # and `amount` values
    # Amount will be called shares
    new_block = Block(
        # For now we will keep this under hashtag: data=input_data,
        record=Record(buyer, seller, shares),
        creator_id=42,
